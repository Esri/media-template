...
define(["require", "exports", "esri/core/tsSupport/declareExtendsHelper", "esri/core/tsSupport/decorateHelper", "esri/core/watchUtils", "esri/core/accessorSupport/decorators", "esri/widgets/Widget", "esri/core/HandleRegistry", "esri/widgets/support/widget", "./Bookmarks/BookmarksViewModel"], function (require, exports, __extends, __decorate, watchUtils, decorators_1, Widget, HandleRegistry, widget_1, BookmarksViewModel) {
    "use strict";
    var CSS = {
        base: "demo-bookmarks",
    ...
    var Bookmarks = /** @class */ (function (_super) {
        ...
        Bookmarks.prototype.render = function () {
            ...
            var bookmarkListNode = state === "ready" && bookmarkNodes.length ? [
                widget_1.tsx("ul", { enterAnimation: fadeInAnimation, 
                    //aria-label={i18n.label}
                    class: CSS.bookmarkList }, bookmarkNodes)
            ] :
                state === "loading" ?
                    loadingNode :
                    null;
        ...
        Bookmarks.prototype._renderBookmark = function (bookmarkItem) {
            ...
            var bookmarkItemClasses = (_a = {},
                ...
                _a);
            return (widget_1.tsx("li", { bind: this, "data-bookmark-item": bookmarkItem, class: this.classes(CSS.bookmarkItem, bookmarkItemClasses), onclick: this._goToBookmark, onkeydown: this._goToBookmark, tabIndex: 0, role: "button", "aria-label": name },
