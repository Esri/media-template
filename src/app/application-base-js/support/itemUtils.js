...
define(["require", "exports", "esri/core/promiseUtils", "esri/core/watchUtils", "esri/views/support/colorUtils", "esri/views/MapView", "esri/views/SceneView", "./urlUtils"], function (require, exports, promiseUtils_1, watchUtils_1, colorUtils_1, MapView_1, SceneView_1, urlUtils_1) {
    "use strict";
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, colorUtils_1.getBackgroundColorTheme(view)];
                    case 1:
                        colorTheme = _a.sent();
                        return [4 /*yield*/, urlUtils_1.parseMarker(marker, colorTheme)];
                    case 2:
                        graphic = _a.sent();
                        if (!graphic) {
                            return [2 /*return*/];
    ...
    function findQuery(query, view) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, SearchViewModel, Locator, source, searchVM, result;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Promise.all([new Promise(function (resolve_3, reject_3) { require(['esri/widgets/Search/SearchViewModel'], resolve_3, reject_3); }).then(__importStar), new Promise(function (resolve_4, reject_4) { require(['esri/tasks/Locator'], resolve_4, reject_4); }).then(__importStar)])];
                    case 1:
                        _a = _b.sent(), SearchViewModel = _a[0], Locator = _a[1];
                        source = {
                        ...
                        return [4 /*yield*/, new SearchViewModel.default({
                                view: view,
                                sources: [source]
                            })];
                    case 2:
                        searchVM = _b.sent();
                        result = searchVM.search(query);
    ...
    function _updateProxiedLayers(webItem, appProxies) {
        ...
        appProxies.forEach(function (proxy) {
            webItem.allLayers.forEach(function (layer) {
                var layerUrl = layer.hasOwnProperty("layerId") ? layer.url + "/" + layer.layerId : layer.url;
