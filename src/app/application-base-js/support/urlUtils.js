...
define(["require", "exports", "esri/Camera", "esri/core/promiseUtils", "esri/geometry/Extent", "esri/geometry/Point"], function (require, exports, Camera_1, promiseUtils_1, Extent_1, Point_1) {
    ...
    function parseMarker(marker, colorTheme) {
        return __awaiter(this, void 0, void 0, function () {
            var markerArray, markerLength, _a, Graphic, PopupTemplate, PictureMarkerSymbol, SimpleMarkerSymbol, x, y, content, icon_url, label, wkid, color, markerSymbol, point, hasPopupDetails, popupTemplate, graphic;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        color = (colorTheme && colorTheme === "light") ? [0, 0, 0, 0, 1] : [255, 255, 255, .25];
