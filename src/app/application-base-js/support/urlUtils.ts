...
export async function parseMarker(marker: string, colorTheme?: string): Promise<esri.Graphic | {}> {
  ...
  const color = (colorTheme && colorTheme === "light") ? [0, 0, 0, 0, 1] : [255, 255, 255, .25]
